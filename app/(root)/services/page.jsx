...
export default function ServicesPage() {
  ...
  return (
    <div className="flex flex-col md:px-7 md:py-7 relative">
      <div className="md:w-full md:px-10 overflow-x-hidden md:py-16 md:pt-72 relative rounded-3xl bg-white   md:mb-10 ">
        ...
        <div className="flex flex-col ">
          <p className=" ml-10 mb-16 text-blackk font-Secondary">
            [Marketing Department]
          </p>
          {/* marketing section content here */}
          <div className="flex flex-row">
            {/* Online Brand Promotion section */}
            <div className="flex-1 border-r-[1px] border-b-[1px] border-gray-300 md:pb-10 ">
              <div className="flex flex-row md:gap-5 items-center justify-start">
                <img src="Assets/Images/Services/monitor-mobbile.png" alt="" />
                <h2 className="md:text-xl font-bold font-Secondary">
                  Online Brand Promotion
                </h2>
              </div>
              <p className="md:ml-[90px] text-gray-400 font-semibold mr-32">
            ...
            {/* end of Online Brand Promotion section */}
            {/* Marketing Performance Analysis */}
            <div className="flex-1  border-b-[1px] border-gray-300">
              <div className="grid grid-cols-[auto_1fr] md:gap-5 items-start   md:pl-10">
                <img src="Assets/Images/Services/status-up.png" alt="" />
                <h2 className="md:text-xl font-bold font-Secondary my-auto">
                  Marketing Performance Analysis
                </h2>
                <p className="col-start-2 text-gray-400 font-semibold mr-32">
            ...
            {/* end of Marketing Performance Analysis */}
          </div>

          <div className="flex flex-row  ">
            {/* Digital Advertising Campaigns Section */}
            <div className="flex-1  border-r-[1px]   border-gray-300 md:pt-16 ">
              <div className="flex flex-row md:gap-5 items-center justify-start ">
                <img src="Assets/Images/Services/book-saved.png" alt="" />
                <h2 className="md:text-xl font-bold font-Secondary">
            ...
            {/* end of Digital Advertising Campaigns Section */}

            {/* Social Media Management */}
            <div className="flex-1">
              <div className="grid grid-cols-[auto_1fr] md:gap-5 items-start md:pt-16 md:pl-10">
                <img src="Assets/Images/Services/category-2.png" alt="" />
                <h2 className="md:text-xl font-bold font-Secondary my-auto">
                  Social Media Management
                </h2>
                <p className="col-start-2 text-gray-400 font-semibold mr-32">
      ...
      <div className="flex flex-col md:px-10 ">
        <div className="grid grid-cols-[10rem_1fr] text-white font-Secondary">
          <p className="text-sm h-fit">[Coders Team]</p>
          <div className="text-4xl flex flex-col md:gap-10">
            <p className="font-semibold text-4xl font-Main">
              Programming <br /> Department
            </p>
            <div className="flex flex-col md:gap-16">
              {generalServices.map((service, index) => (
                <div key={index} className="flex gap-5 flex-col group md:w-3/4">
                  <h2 className="group-hover:md:ml-10 w-fit group-hover:bg-gradient-to-r group-hover:from-secondary group-hover:to-primary group-hover:bg-clip-text group-hover:text-transparent text-white transition-all duration-500">
                    {index + 1} / {service.title}
                  </h2>
                  <p className="opacity-0 group-hover:opacity-100 transition-opacity duration-500 text-base md:ml-10">
                    {service.description}
                  </p>
      ...
      <div className="flex flex-row md:gap-5">
        {/* Our information  */}
        <div className="flex flex-1 overflow-hidden bg-white flex-col md:px-16 md:py-32 rounded-3xl   relative">
          <svg
          ...
          {/* <div className="mx-auto flex flex-col md:gap-16">
            <div className="flex flex-row   md:gap-10">
              <p className="text-[1rem] pt-5">[CALL US]</p>
              <h2 className="text-[3rem] font-bold font-Main">
                LET'S WORK <br />
                WITH US
              </h2>
            </div>
            <div>
              <ul className="flex flex-col  md:gap-5">
                <li className="flex flex-row items-center md:gap-3">
                  <div className="flex items-center justify-center md:px-2 md:py-2 rounded-full bg-secondary">
                    <img src="Assets/Images/Services/telephone.png" alt="" />
                  </div>
                  <div>
                    <p className="text-[0.75rem]">Tel</p>
                    <p className="font-semibold">310-437-2766</p>
                  </div>
                </li>

                <li className="flex flex-row items-center md:gap-3">
                  <div className="flex items-center justify-center md:px-2 md:py-2 rounded-full bg-secondary">
                    <img src="Assets/Images/Services/sms.png" alt="" />
                  </div>
                  <div>
                    <p className="text-[0.75rem]">Mail</p>
                    <p className="font-semibold">unreal@outlook.com</p>
                  </div>
                </li>

                <li className="flex flex-row items-center md:gap-3">
                  <div className="flex items-center justify-center md:px-2 md:py-2 rounded-full bg-secondary">
                    <img src="Assets/Images/Services/location.png" alt="" />
                  </div>
                  <div>
          ...
          <div className="grid grid-cols-[100px_1fr]  md:gap-10">
            <div className="">
              <p className="uppercase text-[1rem]">[Call Us]</p>
            </div>
            <div className="flex flex-col md:gap-10">
              <p className="font-Main font-bold uppercase text-[3rem]">
              ...
              <ul className="flex flex-col  md:gap-5">
                <li className="flex flex-row items-center md:gap-3">
                  ...
                  <div>
                    <p className="text-[1rem]">Tel</p>
                    <p className="font-semibold text-[1.2rem]">310-437-2766</p>
                  </div>
                </li>
        ...
        {/* Send Message */}
        <div className="flex flex-1 md:px-16 md:py-32 bg-white flex-col rounded-3xl relative">
          <div className="flex justify-center w-full flex-col items-center gap-5 font-Secondary">
            <div className="flex rounded-2xl bg-whitee justify-center gap-0  w-full px-5 py-2 ">
              <span className="border-r-[1px] border-gray-400 py-3 pr-5  flex ">
                <img src="Assets/Images/Services/profile.png" alt="" />
              </span>
              <input
                type="text"
                placeholder="Full Name"
                className=" outline-none px-3 bg-whitee  w-full"
              />
            </div>
            ...
            <div className="w-full ">
              <textarea
                className=" rounded-2xl w-full p-7 max-h-40 outline-none  bg-whitee "
                placeholder="Your Text"
              ></textarea>
            </div>
            <button className="bg-secondary w-full px-10 py-5 rounded-2xl">
              Send
            </button>
          </div>
        </div>
      ...
      <div className="flex flex-col bg-white md:w-full rounded-3xl md:mt-10 overflow-hidden  ">
        <div className="flex flex-row md:gap-10 font-Secondary uppercase md:px-10 md:py-16">
          <p className="text-sm">[Uno Team]</p>
          <h2 className="text-4xl font-bold font-Main ">IT Department</h2>
        </div>
        <div className="bg-whitee w-full flex flex-col md:pt-10 md:gap-32 rounded-t-3xl">
          <div className="w-full overflow-hidden">
            <div
              ref={scrollRef}
              className="flex gap-4 overflow-x-auto whitespace-nowrap scroll-smooth scrollbar-hide cursor-pointer  mx-16 select-none    "
            ...
            >
              {detaildServices.map((category, index) => (
                <div
                  ...
                  key={index}
                  className={`   flex flex-row items-center justify-between rounded-full md:gap-8 md:px-6 md:py-4    text-gray-800 font-medium text-lg flex-shrink-0   w-fit ${
                    selectedService === index ? "bg-white" : "bg-transparent"
                  } `}
                >
                  <img src={category.icon} draggable="false" />
          ...
          <div>
            <div className="flex flex-row justify-between">
              <div className="flex-1">
                <img src={detaildServices[selectedService].img} alt="" />
              </div>
              <div className="flex-1 my-auto  flex flex-col justify-between md:gap-5 ">
