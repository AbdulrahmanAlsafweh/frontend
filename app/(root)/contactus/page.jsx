    ...
    <div className="grid md:grid-cols-2 grid-cols-1 lg:py-7 px-7 ">
      ...
      >
        ...
        <div className="flex flex-col   gap-7">
          ...
          <div className="flex-row flex gap-3">
            ...
            <div className="flex flex-col gap-2 ">
              <p className="font-Raleway text-[#222222D6] text-[14px] ">Tel</p>
          ...
          <div className="flex-row flex gap-3">
            ...
            <div className="flex flex-col gap-2 ">
              <p className="font-Raleway text-[#222222D6] text-[14px] ">Mail</p>
        ...
        <div className="flex flex-col  ">
          <p className="font-Raleway font-[16px] text-blackk mb-3">Follow us</p>
